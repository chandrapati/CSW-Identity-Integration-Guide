...
MD_FILES=(
  ...
  "${REPO_ROOT}/ise-pxgrid/01-pxgrid-overview-and-trust.md"
  "${REPO_ROOT}/ise-pxgrid/02-certificate-setup.md"
  "${REPO_ROOT}/ise-pxgrid/03-connector-configuration.md"
  "${REPO_ROOT}/ise-pxgrid/04-troubleshooting.md"
